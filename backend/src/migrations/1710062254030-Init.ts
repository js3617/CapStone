...
export class Init1710062254030 implements MigrationInterface {
    name = 'Init1710062254030'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pharmacy" ("pharmacy_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "product_id" integer NOT NULL, "pharmacy_name" character varying NOT NULL, "pharmacy_address" character varying NOT NULL, "pharmacy_lat" integer NOT NULL, "pharmacy_lng" integer NOT NULL, CONSTRAINT "UQ_c790412594a4e0fbe9b10db78e4" UNIQUE ("pharmacy_name"), CONSTRAINT "PK_e17ca771faa0b6131a2d587c82c" PRIMARY KEY ("pharmacy_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "store" ("store_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "product_id" integer NOT NULL, "store_name" character varying NOT NULL, "store_address" character varying NOT NULL, "store_lat" integer NOT NULL, "store_lng" integer NOT NULL, CONSTRAINT "UQ_70b7d340b9a5de76490930929de" UNIQUE ("store_name"), CONSTRAINT "UQ_eb6e17e3d987697c145d0f2064f" UNIQUE ("store_address"), CONSTRAINT "UQ_aea4c0c88efb647de9ea091e7bd" UNIQUE ("store_lat"), CONSTRAINT "UQ_51e413c0b0bad5cbac5d497bcab" UNIQUE ("store_lng"), CONSTRAINT "PK_94d7b0f600366ceb5c960069687" PRIMARY KEY ("store_id"))`);
